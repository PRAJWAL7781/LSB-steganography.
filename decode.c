...
Status read_and_validate_decode_args(char *argv[], DecodeInfo *decInfo)
{
    ...
    if(dot) *dot = '\0';
    snprintf(decInfo->output_fname, sizeof(decInfo->output_fname), "%s", argv[3]);
...
Status skip_bmp_header(FILE *fptr_src, FILE *fptr_dest)
{
    ...
    printf("Skipping header suceesfully...\n");
    return d_success;
}
...
Status decode_magic_string_len(DecodeInfo *decInfo, int *len)
{
    ...
    printf("Magic string length is suceesfully decoded...\n");
    return d_success;
}
...
Status decode_magic_string(char *magic_str, int len, DecodeInfo *decInfo)
{
    ...
    magic_str[len] = '\0';
    printf("Magic string is suceesfully decoded...\n");
    return d_success;
}
...
Status decode_secret_file_extn_len(DecodeInfo *decInfo, int *extn_len)
{
    ...
    printf("Secret file extension length is suceesfully decoded...\n");
    return d_success;
}
...
Status decode_secret_file_extn(char *extn, DecodeInfo *decInfo)
{
    ...
    printf("Secret file extension is suceesfully decoded...\n");
    return d_success;
}
...
Status decode_secret_file_size(DecodeInfo *decInfo, long *file_size)
{
    ...
    printf("Secret file size is suceesfully decoded...\n");
    return d_success;
}
...
Status decode_secret_file_data(DecodeInfo *decInfo)
{
    ...
    fclose(fptr_output);
    printf("Secret file data is suceesfully decoded...\n");
    return d_success;
}
